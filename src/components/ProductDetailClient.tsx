      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="relative aspect-square w-full rounded-3xl bg-[#121216] border border-neutral-800 p-8 sm:p-14 flex items-center justify-center shadow-2xl overflow-hidden group">
              ...
              {galleryImages.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-neutral-900/80 hover:bg-neutral-800 text-white shadow-md border border-neutral-700 flex items-center justify-center transition-all opacity-80 hover:opacity-100 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-neutral-900/80 hover:bg-neutral-800 text-white shadow-md border border-neutral-700 flex items-center justify-center transition-all opacity-80 hover:opacity-100 cursor-pointer"
                  >
              ...
              {/* Image counter pill */}
              {galleryImages.length > 1 && (
                <div className="absolute bottom-4 right-4 px-2.5 py-1 rounded-full bg-neutral-950/80 text-neutral-300 text-[10px] font-semibold border border-neutral-800 backdrop-blur-xs">
                ...
                {galleryImages.map((img, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative w-20 h-20 rounded-2xl overflow-hidden border p-2 bg-[#141418] transition-all cursor-pointer ${
                        isSelected
            ...
            <div className="pt-4 space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {/* 1. Batería */}
                <div className="p-3.5 rounded-2xl bg-[#121216] border border-neutral-800/80 shadow-2xs flex items-center gap-3">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <span className="px-3 py-1 rounded-md text-xs font-extrabold bg-neutral-800 text-neutral-200 tracking-wider uppercase">
                  {product.brand}
                </span>
            ...
            <div className="p-5 rounded-2xl bg-[#121216] border border-neutral-800 shadow-xl space-y-4">
              <div>
              ...
              <div className="p-3.5 rounded-xl bg-emerald-950/40 border border-emerald-800/50 text-xs text-emerald-200 space-y-1.5">
              ...
              <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl bg-blue-950/40 border border-blue-800/50 text-xs text-blue-200 font-medium">
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center border border-neutral-800 rounded-xl bg-[#18181f] shadow-2xs">
                  <button
                    onClick={() => setQuantity((q) => Math.max(1, q - 1))}
                    className="px-3.5 py-2 text-neutral-400 hover:text-white font-bold text-sm cursor-pointer"
                  >
                    -
                  </button>
                  <span className="px-3 py-2 text-xs font-bold text-white min-w-8 text-center">
                    {quantity}
                  </span>
                  <button
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl border border-neutral-700 hover:border-neutral-500 bg-[#18181f] hover:bg-neutral-800 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all active:scale-98 shadow-xs cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl bg-white hover:bg-neutral-200 text-neutral-950 font-bold text-xs flex items-center justify-center gap-2 transition-all active:scale-98 shadow-sm cursor-pointer"
                >
            ...
            <div className="pt-4 border-t border-neutral-800 space-y-4">
              <div>
                <h3 className="text-sm font-bold text-white mb-2">Descripción del Producto</h3>
                <p className="text-xs text-neutral-400 leading-relaxed">{product.description}</p>
              </div>

              <div>
                <h3 className="text-sm font-bold text-white mb-2">Características Principales</h3>
                <ul className="space-y-2 text-xs text-neutral-300">
                  {product.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <div className="w-4 h-4 rounded-full bg-blue-950/60 text-blue-400 flex items-center justify-center shrink-0 mt-0.5">
