  ...
  return (
    <aside aria-label="Contacto oficial por WhatsApp" className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="group flex items-center gap-3 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-[0_10px_25px_rgba(37,211,102,0.35)] hover:shadow-[0_14px_32px_rgba(37,211,102,0.45)] hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer"
      ...
      >
        ...
        <div className="relative flex items-center justify-center shrink-0">
          ...
          <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-200 rounded-full border-2 border-[#25D366]" />
        </div>
