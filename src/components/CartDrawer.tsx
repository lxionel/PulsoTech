              ...
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="flex items-center gap-1.5 text-neutral-600 font-medium">
                  ...
                  {freeShippingRemaining === 0 ? (
                    <strong className="text-emerald-700">¡Tienes Envío Gratis!</strong>
                  ) : (
                    <span>
                      Faltan <strong className="text-neutral-900">{STORE_SETTINGS.currencySymbol}{freeShippingRemaining.toFixed(2)}</strong> para Envío Gratis
                    </span>
                  )}
                </span>
          ...
          <div className="flex-1 overflow-y-auto py-4 space-y-3 pr-1">
            {items.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-3">
                ...
                <button
                  onClick={() => setIsCartOpen(false)}
                  className="mt-2 px-4 py-2 rounded-full bg-black text-white text-xs font-medium hover:bg-neutral-800 transition-colors"
                >
                  Ver Catálogo
                </button>
              </div>
              ...
              items.map((item) => (
                <div
                  ...
                  className="flex gap-3.5 p-3 rounded-2xl bg-neutral-50 border border-neutral-200/70"
                >
                  <div className="relative w-16 h-16 rounded-xl overflow-hidden bg-white border border-neutral-200 shrink-0">
                    <Image
                  ...
                  <div className="flex flex-col items-end justify-between">
                    ...
                    <div className="flex items-center gap-1.5 border border-neutral-200 rounded-full p-0.5 bg-white">
                      <button
                        onClick={() =>
          ...
          {items.length > 0 && (
            <div className="pt-4 border-t border-neutral-200 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-0.5">
                    <button
                      ...
                      className={`py-1.5 px-2 rounded-xl text-[11px] font-semibold border text-center transition-colors ${
              ...
              <button
                ...
                className="w-full py-4 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md active:scale-95 transition-all"
              >
